...
export const ChatProvider = ({ children }) => {
  ...
  async function showChats(type) {
    let response = await fetch("http://corporate-messenger.itsk.pw:8080/chat/showChats", {
      method: "POST",
      headers: {
  ...
  const makePin = async () => {
    let response = await fetch("http://corporate-messenger.itsk.pw:8080/chat/pinned", {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        Authorization: String(authTokens.accessToken),
  ...
  const DelPin = async () => {
    let response = await fetch("http://corporate-messenger.itsk.pw:8080/chat/dePinned", {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        Authorization: String(authTokens.accessToken),
  ...
  const connect = () => {
    var sockJS = new SockJS("http://corporate-messenger.itsk.pw:8080/ws");
  ...
  const takeLinks = async (num) => {
    let response = await fetch("http://corporate-messenger.itsk.pw:8080/chat/getRef", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: String(authTokens.accessToken),
