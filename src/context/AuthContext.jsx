...
export const AuthProvider = ({ children }) => {
  ...
  let registerUser = async (data) => {
    ...
    let response = await fetch("http://corporate-messenger.itsk.pw:8080/auth/register", {
      method: "POST",
      headers: {
  ...
  let updateToken = async (data) => {
    let response = await fetch("http://corporate-messenger.itsk.pw:8080/auth/token", {
      method: "POST",
      headers: {
  ...
  let loginUser = async (data) => {
    ...
    let response = await fetch("http://corporate-messenger.itsk.pw:8080/auth/login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async function changeData(data, photo, name) {
    ...
    let response = await fetch("http://corporate-messenger.itsk.pw:8080/change/userData", {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
