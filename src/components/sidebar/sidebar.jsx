...
import { NavLink, useMatch, useParams, useLocation } from "react-router-dom";
          ...
          <div id="sidebar_main">
            <div id="sidebar_main_default">
              <NavLink
                to={`chat/start`}
                className={({ isActive }) =>
                  location.pathname.indexOf(`chat`) != -1 ? "sidebar_choice activeSidebar" : "sidebar_choice"
                }
              >
              ...
              <NavLink
                to={`groupchat/start`}
                className={({ isActive }) =>
                  location.pathname.indexOf(`groupchat`) != -1 ? "sidebar_choice activeSidebar" : "sidebar_choice"
                }
              >
                <div className="sidebar_main_topics">
